...
//        Task23
        ...
        // Task6
        // В нашем случае мы проверяем перевернутый массив, т.к. в задании 5 мы поменяли элементы местами,
        // можно поменять местами код или создать перед заданием 5 клон оригинального массива и в задании 6 проверять его
